...
def main():
    ...
    for txt in txtes:
        ...
        acc = calculate.MOTAccumulator(auto_id=True)
        ...
        strsummary = calculate.io.render_summary(
            summary,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='dataset/MOT17/', help='dataset root path')

    parser.add_argument('--resuld_dir', default='result/texts/', help='txt files path')

    parser.add_argument('--threshold', dest='threshold', default=0.5, type=float, help='distance matrix threshold')
